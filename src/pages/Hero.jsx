...
//           <div className="inline-flex items-center gap-3 mb-6 lg:mb-8 px-4 lg:px-5 py-2 rounded-full border border-yellow-400/20 bg-yellow-400/5 backdrop-blur-xl">
...
//           <h1 className="text-[44px] sm:text-[64px] md:text-[80px] lg:text-[100px] xl:text-[120px] leading-[0.95] lg:leading-[0.9] tracking-[-0.05em] lg:tracking-[-0.06em] font-light">
//             Crafted<br className="hidden sm:block" />
//             <span className="text-yellow-400 italic"> for forever.</span>
//           </h1>

          
//           <p className="mt-6 lg:mt-8 text-white/55 text-sm sm:text-base md:text-lg leading-relaxed max-w-[480px] lg:max-w-[540px]">
//             {product?.description
    ...
    <section className="relative min-h-screen overflow-hidden bg-black flex items-center pt-28 pb-12 md:py-20 lg:py-0">
      ...
      >
        <div className="order-2 lg:order-1 lg:col-span-7 max-w-[720px] text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          {/* Big and tight canvas layout wrapper */}
          <h1 className="w-full flex items-center justify-center lg:justify-start overflow-hidden">
            <TextDisintegrate sequence={customSequence} duration={4500} />
          </h1>

          {/* Styled Sub-paragraph: Crisp, light weights, elite spacing */}
